...
import torch
from model.tools.rotation import quat_to_mat, mat_to_quat
...
def pose_encoding_to_extri_intri(
    ...
    if pose_encoding_type == "absT_quaR_FoV":
        ...
        bottom_row = bottom_row.view(1, 1, 1, 4).expand(*extrinsics.shape[:2], 1, 4)  # shape: [B, T, 1, 4]
        extrinsics_homo = torch.cat([extrinsics, bottom_row], dim=-2)  # shape: [B, T, 4, 4]
        if build_intrinsics:
    ...
    return extrinsics_homo, intrinsics
